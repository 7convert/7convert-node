...
describe('JobsResouce', () => {
    ...
    describe('all()', () => {
        ...
        it('should fetch all jobs', async () => {
            ...
            const data = await this.sevenConvert.jobs.all();
    ...
    describe('get()', () => {
        ...
        it('should fetch a job by id', async () => {
            ...
            const data = await this.sevenConvert.jobs.get('cd82535b-0614-4b23-bbba-b24ab0e892f7');
    ...
    describe('create()', () => {
        ...
        it('should send the create request', async () => {
            ...
            const data = await this.sevenConvert.jobs.create({
                'tag': 'test',
                'tasks': {}
            });
    ...
    describe('delete()', () => {
        ...
        it('should send the delete request', async () => {
            ...
            await this.sevenConvert.jobs.delete('2f901289-c9fe-4c89-9c4b-98be526bdfbf');
