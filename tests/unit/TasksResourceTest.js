...
describe('TasksResouce', () => {
    ...
    describe('all()', () => {
        ...
        it('should fetch all tasks', async () => {
            ...
            const data = await this.sevenConvert.tasks.all();
    ...
    describe('get()', () => {
        ...
        it('should fetch a task by id', async () => {
            ...
            const data = await this.sevenConvert.tasks.get('4c80f1ae-5b3a-43d5-bb58-1a5c4eb4e46b');
    ...
    describe('create()', () => {
        ...
        it('should send the create request', async () => {
            ...
            const data = await this.sevenConvert.tasks.create('convert', {
                'name': 'test',
                'url': 'http://invalid.url',
                'filename': 'test.file'
            });
    ...
    describe('delete()', () => {
        ...
        it('should send the delete request', async () => {
            ...
            await this.sevenConvert.tasks.delete('2f901289-c9fe-4c89-9c4b-98be526bdfbf');
    ...
    describe('upload()', () => {
        ...
        it('should send the upload request', async () => {
            ...
            const task = await this.sevenConvert.tasks.create('import/upload');


            nock('https://upload.sandbox.7convert.com.cn', {
                reqheaders: {
                    'Content-Type': /multipart\/form-data/i,
                }
            })
                .post('/storage.de1.cloud.ovh.net/v1/AUTH_b2cffe8f45324c2bba39e8db1aedb58f/sevenconvert-files-sandbox/8aefdb39-34c8-4c7a-9f2e-1751686d615e/?s=jNf7hn3zox1iZfZY6NirNA&e=1559588529')
                .reply(201)
